...
CREATE TABLE categories(
	id INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL DEFAULT '' COMMENT 'Ten danh muc san pam'
);
-- Product
...
CREATE TABLE orders(
    ...
    user_id INT,
    FOREIGN KEY (user_id) REFERENCES users(id),
    fullname VARCHAR(100) COMMENT 'Vi co the khac ten khi dang ky tai khoan' DEFAULT '',
    email VARCHAR(100) COMMENT 'Vi co the khac email khi dang ky tai khoan' DEFAULT '',
